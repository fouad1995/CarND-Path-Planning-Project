        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for ( int i = 0; i < sensor_fusion.size(); i++ ) {
                ...
                if ( car_lane == lane ) {
                  // Car in our lane.
                  forwardCar |= check_car_s > car_s && check_car_s - car_s < 30;
                } else if ( car_lane - lane == -1 ) {
                  // Car left
                  leftCar |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                } else if ( car_lane - lane == 1 ) {
                  // Car right
                  rightCar |= car_s - 30 < check_car_s && car_s + 30 > check_car_s;
                }
            }
            ...
            if ( forwardCar ) { // Car ahead
              ...
              if ( lane != 1 ) { // if we are not on the center lane.
                if ( ( lane == 0 && !rightCar ) || ( lane == 2 && !leftCar ) ) {
